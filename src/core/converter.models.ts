...
export class ConverterModels {
    ...
    private getAgentOutput(agentResult: any): AgentOutput {
     ...
     * @returns 
     */
    public getAgentContent(agentResult: any): string {
        return this.getAgentOutput(agentResult).result;
    }
    ...
    * In futuro prompt con all'interno variabili placeholder avranno una gestione tale da essere compilati tra piu catene di domanda e risposta
    ...
    public getConfigChainpromptDFL(): ConfigChainPrompt {
     ...
     * @returns 
     */
    public getDataRequestDFL(): DataRequest {
        ...
        let config: ConfigChainPrompt = {
            ...this.getConfigChainpromptDFL(), temperature, modelname, maxTokens, numCtx, format
        };

        return { question, keyconversation, noappendchat, config };
    }

    public getConfigEmbeddingsDFL(): ConfigEmbeddings {
